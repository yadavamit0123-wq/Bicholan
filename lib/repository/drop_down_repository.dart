...
class DropDownRepository {
  ...
  Future<AstronomicDropdownResponse> fetchAstronomicDropDown() async {
    var baseUrl = "${AppConfig.BASE_URL}/member/astronomic/dropdowns";
    var accessToken = SharedPref().accessToken;
    ...
    var data = astronomicDropdownResponseFromJson(response.body);
    return data;
  }
