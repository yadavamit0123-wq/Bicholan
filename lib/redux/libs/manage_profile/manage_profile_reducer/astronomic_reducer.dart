...
class AstronomicDropdownSetAction {
  final AstronomicDropdownResponse data;
  AstronomicDropdownSetAction(this.data);
}
...
AstronomicState? astronomic_reducer(AstronomicState? state, dynamic action) {
  ...
  if (action is AstronomicDropdownSetAction) {
    return astro_dropdown_set(state!, action);
  }
  return state;
}
...
astro_dropdown_set(AstronomicState state, AstronomicDropdownSetAction action) {
  state.astronomicDropdownResponse = action.data;
  return state;
}
