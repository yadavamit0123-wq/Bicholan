...
class PP_PhysicalAttributes extends StatelessWidget {
  const PP_PhysicalAttributes({super.key});
  ...
  Widget build(BuildContext context) {
    return StoreConnector<AppState, AppState>(
      ...
      builder:
          (_, state) =>
              state.publicProfileState!.physical != null
                  ? Column(
                    children: [
                      buildRow(
                        context: context,
