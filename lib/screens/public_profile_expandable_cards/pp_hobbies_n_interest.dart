...
class PP_HobbiesInterest extends StatelessWidget {
  const PP_HobbiesInterest({super.key});
  ...
  Widget build(BuildContext context) {
    return StoreConnector<AppState, AppState>(
      ...
      builder:
          (_, state) =>
              state.publicProfileState!.hobbies != null
                  ? Column(
                    children: [
                      buildRow(
                        context: context,
