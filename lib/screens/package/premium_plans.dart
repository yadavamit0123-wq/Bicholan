...
import '../../repository/profile_setting_repo.dart';
...
class _PremiumPlansState extends State<PremiumPlans> {
  int hasPurchasedFreePackage = 0;
  bool isProfileSettingsLoading = true;
  ...
  getProfileSettingsData() async {
    var value =
        await ProfileSettingsRepository().fetchHasPurchasedFreePackage();

    if (mounted) {
      setState(() {
        hasPurchasedFreePackage = value;
  ...
  Widget build(BuildContext context) {
    return StoreConnector<AppState, PremiumPlansViewModel>(
      ...
      builder:
          (_, PremiumPlansViewModel vm) => WillPopScope(
            onWillPop: () async {
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                title: Text(
                  AppLocalizations.of(context)!.premium_plans_appbar_title!,
  ...
  Widget buildListView(PremiumPlansViewModel vm) {
    return ListView.separated(
      ...
      separatorBuilder:
          (BuildContext context, int index) => const SizedBox(width: 20),
      itemBuilder: (BuildContext context, int index) {
        bool isFreePackage = vm.list![index].packageId == 1;
        bool isFreePackageLoading = isFreePackage && isProfileSettingsLoading;
        bool alreadyPurchasedFree =
            isFreePackage && (hasPurchasedFreePackage == 1);
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Text(
                          ...
                          style:
                              vm.list![index].autoProfileMatch == 1
                    ...
                    TextButton(
                      onPressed:
                          (alreadyPurchasedFree || isFreePackageLoading)
                              ? null
                              : () async {
                                if (vm.isDeactivated!) {
                                ...
                                if (!store.state.userVerifyState!.isApprove!) {
                                  ...
                                  NavigatorPush.push(context, const Account());
                                  return;
                                }
                      ...
                      child:
                          isFreePackageLoading
                              ...
                              : Text(
                                isFreePackage ? 'Activate' : 'Purchase',
                                style:
                                    alreadyPurchasedFree
                                        ? Styles.bold_white_14.copyWith(
                                          decoration:
...
class PremiumPlansViewModel {
  ...
  static fromStore(Store<AppState> store) {
    return PremiumPlansViewModel(
      ...
      pictureImagePrivacy: settingIsActive(
