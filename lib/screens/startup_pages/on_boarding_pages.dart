                                  ...
                                  child: PageView.builder(
                                    ...
                                    itemBuilder: (context, index) {
                                      return AppInfoCard(
                                        itemIndex: index,
                                        itemLength:
                                            state.appInfoState!.list!.length,
                                        icon:
                                            state
                                                .appInfoState!
                                                .list![index]
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(
            child:
                icon != null
                    ? Image.network(icon!, height: 72, width: 85)
                    : const Icon(Icons.error),
          ),
          Const.height15,
          //  number position in the how it works screen
          Text("$steps", style: Styles.bold_white_36),
          Const.height15,
          Text(hwt_title!, style: Styles.bold_white_22),
          Const.height15,
          SizedBox(
            width: 200,
            child: Text(
