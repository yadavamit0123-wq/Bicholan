...
import 'package:active_matrimonial_flutter_app/screens/my_dashboard_pages/wallet/wallet_history_middleware.dart';
    ...
    return StoreConnector<AppState, AppState>(
      ...
      builder:
          (_, state) => WillPopScope(
            ...
            child: Scaffold(
              appBar: CommonAppBar(
                text: AppLocalizations.of(context)!.wallet_screen,
              ).build(context),
  ...
  Widget buildListViewSeparated(AppState state) {
    return Expanded(
      child: SingleChildScrollView(
        ...
        child:
            state.myWalletState!.balanceHistory!.isNotEmpty
                ? ListView.separated(
                  shrinkWrap: true,
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    ...
                    return WalletHistoryCard(
                      ...
                      amount:
                          state.myWalletState!.balanceHistory![index].amount,
                      paymentMethod:
                          state
                              .myWalletState!
