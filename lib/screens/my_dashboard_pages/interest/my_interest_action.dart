...
///
class RemoveMyInterestAction {
  int interestId;

  RemoveMyInterestAction({required this.interestId});
}

class RemoveMyInterestSuccessAction {
  int interestId;

  RemoveMyInterestSuccessAction({required this.interestId});
}
