    ...
    return Expanded(
      child: Column(
        ...
        children: [
          ...
          Expanded(
            child:
                state.galleryImageState!.isFetching!
                    ? CommonWidget.circularIndicator
                    : Container(
                      child:
                          state.galleryImageState!.galleryImageList!.isNotEmpty
                              ? imageGrid(state)
                              : CommonWidget.noData,
                    ),
          ),
          ...
          (context) => StatefulBuilder(
            builder: (context, StateSetter setState) {
              return AlertDialog(
                ...
                content: TextButton(
                  onPressed:
                      () => store.dispatch(getGalleryImageAction(setState)),
                  style: ButtonStyle(
        ...
        Row(
          children: [
            ...
            if (state.accountState!.profileData?.memberPhoto == null)
              const CircleAvatar(
                radius: 25,
                foregroundImage: AssetImage('assets/images/default_avater.png'),
              )
            else
              CircleAvatar(
                radius: 25,
