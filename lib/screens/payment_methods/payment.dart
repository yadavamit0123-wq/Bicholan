...
import 'package:active_matrimonial_flutter_app/screens/payment_methods/instamojo_screen.dart';
import 'package:active_matrimonial_flutter_app/screens/payment_methods/payment_types_action.dart';
import 'package:active_matrimonial_flutter_app/screens/payment_methods/payment_types_middleware.dart';
...
import 'package:active_matrimonial_flutter_app/screens/payment_methods/razorpay_screen.dart';
...
import '../package/package_middlewares.dart';
              ...
              if (widget.payment_type == 'wallet_payment') {
                if (!_formKey.currentState!.validate()) {
                  ...
                  onPressPlaceOrderOrProceed(
                    ...
                    index:
                        state.paymentTypesState!.selected_payment_method_index,
                  );
                ...
                onPressPlaceOrderOrProceed(
                  state,
                  package_id: widget.package_id,
                  index: state.paymentTypesState!.selected_payment_method_index,
                );
                // _amount_controller.clear();
              }
            },
