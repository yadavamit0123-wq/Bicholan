...
class SpiritualSocial extends StatefulWidget {
  const SpiritualSocial({super.key});
...
class _SpiritualSocialState extends State<SpiritualSocial> {
          ...
          (_, state) => Scaffold(
            appBar: CommonAppBarManageProfile(
              text:
                  AppLocalizations.of(
                    context,
                  )!.public_profile_spiritual_n_social,
            ).build(context),
            body: SafeArea(
              child: Padding(
          ...
          InkWell(
            onTap: () {
              ...
              if (!_formKey.currentState!.validate()) {
                ...
                store.dispatch(
                  spiritualSocialUpdateMiddleware(
                    religion:
                        state
                            .manageProfileCombineState!
                            .spiritualSocialState!
  ...
  build_community_value(BuildContext context, AppState state) {
    return Column(
      ...
      children: [
        Text(
          AppLocalizations.of(context)!.manage_profile_community_val,
          style: Styles.bold_arsenic_12,
        ),
        const SizedBox(height: 5),
        TextFormField(
