...
import 'package:active_matrimonial_flutter_app/screens/my_dashboard_pages/gallery/gallery_image_middleware.dart';
  ...
  List<Widget> profileSections() {
    return [
      ...
      MyProfileListData(
        ...
        pp: PP_UserContactDetails(userid: store.state.authState!.userData!.id),
        percentage:
            PercentageCalculator(
              data:
                  store
      ...
      if (settingIsActive("member_career_section", "on"))
        MyProfileListData(
          ...
          percentage:
              PercentageCalculator(
                data: store.state.manageProfileCombineState!.careerState!.list,
              ).getCareerPercentage(),
        ).getWidget(context),
              ...
              InkWell(
                onTap: () {
                  ...
                  if (!_formKey.currentState!.validate()) {
                    ...
                    store.dispatch(
                      partnerExpectationUpdateMiddleware(
                        general_info:
                            store
                                .state
                                .manageProfileCombineState!
                  ...
                  tabs: [
                    Tab(
                      child: NavigationButton(
                        color:
                            state.manageProfileCombineState!.selectedTabIndex ==
                                    0
    ...
    return SingleChildScrollView(
      child: Padding(
        ...
        child: ListView.separated(
          ...
          separatorBuilder: (context, index) => Const.height20,
            ...
            children: [
              ...
              Container(
                ...
                child: CommonWidget().buildDropdownButtonFormField(context,
                  ...
                  (value) {
                    store.dispatch(
                      PexMaritalStatusAddValueAction(value: value),
                    );
                  },
                  value:
                      state
              ...
              Container(
                ...
                child: CommonWidget().buildDropdownButtonFormField(context,
                  ...
                  (value) {
                    ...
                    store.dispatch(
                      PexPreferredCountryAddValueAction(value: value),
                    );
