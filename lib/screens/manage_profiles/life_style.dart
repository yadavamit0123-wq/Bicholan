...
class _LifeStyleState extends State<LifeStyle> {
  ...
  Widget build(BuildContext context) {
    return StoreConnector<AppState, AppState>(
      ...
      builder:
          (_, state) =>
              state.manageProfileCombineState!.lifeStyleState!.isLoading ==
                      false
                  ? Scaffold(
                  ...
                  : Center(
                    child: CircularProgressIndicator(color: MyTheme.storm_grey),
                  ),
    );
  }
          ...
          child: DropdownButtonFormField(
            ...
            value:
                store
                    ...
                    .diet_value,
            items:
                store.state.manageProfileCombineState!.lifeStyleState!.items
