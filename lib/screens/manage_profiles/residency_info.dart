...
class ResidencyInformation extends StatefulWidget {
  const ResidencyInformation({super.key});
...
class _ResidencyInformationState extends State<ResidencyInformation> {
  ...
  final TextEditingController _immigration_status = TextEditingController(
    text:
        store
                    .state
  ...
  Widget build(BuildContext context) {
    return StoreConnector<AppState, AppState>(
      ...
      builder:
          (_, state) =>
              state.manageProfileCombineState!.residencyState!.isloading ==
                      false
                  ? Scaffold(
