...
import 'package:active_matrimonial_flutter_app/screens/blog/blog_middleware.dart';
...
class _BlogPageState extends State<BlogPage> {
  ...
  Widget build(BuildContext context) {
    return StoreConnector<AppState, AppState>(
      onInit:
          (store) => [
            store.dispatch(Reset.blogList),
            store.dispatch(blogMiddleware()),
          ],
  ...
  Widget buildBlogCards(AppState state) {
    return Expanded(
      child:
          state.blogState!.blogList!.isNotEmpty
