    ...
    return Row(
      ...
      children: [
        ...
        IconButton(
          ...
          icon: Image.asset('assets/icon/icon_copy.png', height: 22),
  ...
  Widget buildListViewSeparated(BuildContext context, AppState state) {
    return RefreshIndicator(
      ...
      child: SingleChildScrollView(
        ...
        child:
            state.referralState!.referralUserList!.isNotEmpty
                ? ListView.separated(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    if (index ==
                        state.referralState!.referralUserList!.length) {
                      return Padding(
                        padding: const EdgeInsets.symmetric(vertical: 10),
                        child: Center(
                          child:
                              state.referralState!.hasMore!
