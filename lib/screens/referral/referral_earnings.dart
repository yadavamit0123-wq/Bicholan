...
import '../../components/name_date_row.dart';

class RefferalEarnings extends StatefulWidget {
  const RefferalEarnings({super.key});
  ...
  Widget buildListViewSeparated(BuildContext context, AppState state) {
    return Expanded(
      child: Padding(
        ...
        child:
            state.referralEarningState!.referralEarningList!.isNotEmpty
                ? ListView.separated(
                  // shrinkWrap: true,
                  itemCount:
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    if (index ==
                      ...
                      return Padding(
                        ...
                        child: Center(
                          child:
                              state.referralEarningState!.hasMore!
