...
import 'post_happy_story_middleware.dart';
...
class _MyHappyStoriesState extends State<MyHappyStories> {
  ...
  final TextEditingController _story_titleController = TextEditingController();
  final TextEditingController _story_partnerNameController =
      TextEditingController();
  final TextEditingController _story_videoLinkController =
      TextEditingController();
  var videoProvider =
      store.state.myHappyStoryState!.result == false
          ? null
    ...
    return StoreConnector<AppState, AppState>(
      ...
      builder:
          (_, state) => Scaffold(
            ...
            body:
                state.myHappyStoryState!.result!
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              Text(
                state.myHappyStoryState!.myHappyStory!.date!,
