...
import 'package:active_matrimonial_flutter_app/screens/ignore/ignore_middleware.dart';
import 'package:flutter/material.dart';
import 'package:active_matrimonial_flutter_app/l10n/app_localizations.dart';

class Ignore extends StatefulWidget {
  const Ignore({super.key});
...
class _IgnoreState extends State<Ignore> {
  ...
  Widget build(BuildContext context) {
    return StoreConnector<AppState, AppState>(
      ...
      builder:
          (_, state) => Scaffold(
            appBar: CommonAppBar(
              text: AppLocalizations.of(context)!.ignore_screen_ignore_members,
            ).build(context),
            body: Column(
              children: [
  ...
  Widget buildListViewSeparated(BuildContext maincontext, AppState state) {
    return Expanded(
      child:
          state.ignoreState!.ignoreList!.isEmpty
              ? CommonWidget.noData
              : ListView.separated(
