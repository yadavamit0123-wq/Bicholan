...
class CommonWidget {
  ...
  DropdownButtonFormField<DDown> buildDropdownButtonFormField(
    ...
    return DropdownButtonFormField<DDown>(
      ...
      decoration: InputDecoration(
        hintText: "Select one",
        isDense: true,
        hintStyle: Styles.regular_gull_grey_12.copyWith(
  ...
  static Widget noMoreData = const Center(child: Text("No more data"));
  ...
  static Widget dialogCrossBtn = IconButton(
    ...
    icon: Image.asset('assets/icon/icon_cross.png', height: 16, width: 16),
  );
}
